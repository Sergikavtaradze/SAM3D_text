...
#$ -N Train_GPT2_MaskWise_128crop_lr4e-4_hidden_dim_test_Oct29
#$ -o /cluster/project7/SAMed/samed_codes/3DSAM-adapter/3DSAM-adapter/job_info/Oct/Oct29
#$ -e /cluster/project7/SAMed/samed_codes/3DSAM-adapter/3DSAM-adapter/job_info/Oct/Oct29
#$ -wd /home/mobislam
...
# Debug to confirm imports come from the env, not ~/.local
python -s - <<'PY'
...
python3 train_mobarak_GPT.py --data maskwise_endonasal \
